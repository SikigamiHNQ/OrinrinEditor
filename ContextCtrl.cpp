...
/*25*/	{  TEXT(" 4 dot SPACE"),					IDM_IN_04SPACE			},
...
/*40*/	{  TEXT("枠（４）"),						IDM_INSFRAME_DELTA		},
...
/*85*/	{  TEXT("複数行テンプレート表示"),			IDM_MAATMPLE_VIEW		},
