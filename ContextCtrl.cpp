...
/*50*/	{  TEXT("縦書き変換ボックス"),			TEXT(""),			IDM_VERT_SCRIPT_OPEN	},
		{  TEXT("ユーザ定義"),					TEXT(""),			IDM_MN_USER_REFS		},//サブメニューダミー
		{  TEXT("各頁に通し番号を入れる"),		TEXT(""),			IDM_PAGENUM_DLG_OPEN	},
		{  TEXT("（セパレータ）"),				TEXT(""),			0						},
		{  TEXT("右揃え線"),	/*整形*/		TEXT("Ctrl + Alt + R"),		IDM_RIGHT_GUIDE_SET	},
/*55*/	{  TEXT("行頭に全角空白追加"),			TEXT("Ctrl + I"),			IDM_INS_TOPSPACE	},
		{  TEXT("行頭空白削除"),				TEXT("Ctrl + U"),			IDM_DEL_TOPSPACE	},
...
/*60*/	{  TEXT("頁全体を空白で埋める"),		TEXT(""),					IDM_FILL_ZENSP		},
		{  TEXT("右に寄せる"),					TEXT(""),					IDM_RIGHT_SLIDE		},
