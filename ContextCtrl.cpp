...
/*95*/	{  TEXT("全体を１ドット右へ"),				IDM_INCR_DOT_LINES		},
		...
		{  TEXT("（セパレータ）"),					0						},
/*100*/	{  TEXT("空白を表示"),	/*表示*/			IDM_SPACE_VIEW_TOGGLE	},
...
/*135*/	{  TEXT("表示画面再描画"),					IDM_NOW_PAGE_REFRESH	},
...
/*140*/	{  TEXT("（未実装）新しい文字列を検索"),	IDM_FIND_TARGET_SET		},
		{  TEXT("（セパレータ）"),					0						}
};

#define ALL_ITEMS	 114	//	右クリ用　０インデックス
#define FULL_ITEMS	 142	//	全アイテム
